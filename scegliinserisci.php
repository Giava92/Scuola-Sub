...
<html>
    ...
    <body>
        ...
        <div id="breadcrumb">
            Ti trovi in: <a href="index.php"> Home</a> >><a href="sezioneamm.php"> Sezione amministratore</a> >> Scelta inserimento
        </div>
        ...
        <div id="content">
            ...
            if ($username != "Admin" && $username != "admin") {
                ...
                echo<<<END
        <form class="fc" method="post" action="inserisci.php">
        <fieldset>     
        <div>
        <label>Tipo di dati da inserire:</label>
        <select name = "tipo_ins">
