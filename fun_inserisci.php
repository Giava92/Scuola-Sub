...
function inserisci($cosa){
                ...
                case 'AttrezzatureScuola':
                    echo<<<END
                    <p>Scegli i valori per l'inserimento attrezzatura:</p>
                    <form class="fc" action = "ver_inserisci.php" method = "post">
                    <fieldset>
                    <div>
...
END;
                ...
                case 'Brevetti':
                    echo<<<END
                    <p>Scegli i valori per l'inserimento brevetto:</p>
                    <form class="fc" action = "ver_inserisci.php" method = "post">
                    <fieldset>
                    <div>
...
END;
                ...
                case 'Corsi':
                    echo<<<END
                    <p>Scegli i valori per l'inserimento corso:</p>
                    <form class="fc" action = "ver_inserisci.php" method = "post">
                    <fieldset>
                    <div>
...
END;
                ...
                case 'Eventi':
                    echo<<<END
                    <p>Scegli i valori per l'inserimento evento:</p>
                    <form class="fc" action = "ver_inserisci.php" method = "post">
                    <fieldset>
                    <div>
...
END;
                ...
                case 'EventiSoci':
                    echo<<<END
                    <p>Scegli i valori per l'inserimento campo tabella eventisoci:</p>
                    <form class="fc" action = "ver_inserisci.php" method = "post">
                    <fieldset>
                    <div>
                    <label>Evento:</label>
...
END;
                ...
                case 'Immersioni':
                    echo<<<END
                    <p>Scegli i valori per l'inserimento immersione:</p>
                    <form class="fc" action = "ver_inserisci.php" method = "post">
                    <fieldset>
                    <div>
...
END;
                ...
                case 'ImmersioniSub':
                    echo<<<END
                    <p>Scegli i valori per l'inserimento camo tabella immersionisub:</p>
                    <form class="fc" action = "ver_inserisci.php" method = "post">
                    <fieldset>
                    <div>
...
END;
                ...
                case 'Lezioni':
                     echo<<<END
                    <p>Scegli i valori per l'inserimento lezione:</p>
                    <form class="fc" action = "ver_inserisci.php" method = "post">
                    <fieldset>
                    <div>
...
END;
                ...
                case 'Noleggi':
                    echo<<<END
                    <p>Scegli i valori per l'inserimento noleggio:</p>
                    <form class="fc" action = "ver_inserisci.php" method = "post">
                    <fieldset>
                    <div>
                    <label>Sub:</label>
...
END;
                ...
                case 'Persone':
                     echo<<<END
                    <p>Scegli i valori per l'inserimento persona:</p>
                    <form class="fc" action = "ver_inserisci.php" method = "post">
                    <fieldset>
                    <div>
...
END;
                ...
                case 'PersoneCorsi':
                    echo<<<END
                    <p>Scegli i valori per l'inserimento campo tabella personecorsi:</p>
                    <form class="fc" action = "ver_inserisci.php" method = "post">
                    <fieldset>
                    <div>
                    <label>Persona:</label>
...
END;
                ...
                case 'PersoneEventi':
                    echo<<<END
                    <p>Scegli i valori per l'inserimento campo tabella personeeventi:</p>
                    <form class="fc" action = "ver_inserisci.php" method = "post">
                    <fieldset>
                    <div>
                    <label>Evento:</label>
...
END;
                ...
                case 'Riunioni':
                     echo<<<END
                    <p>Scegli i valori per l'inserimento riunione:</p>
                    <form class="fc" action = "ver_inserisci.php" method = "post">
                    <fieldset>
                    <div>
...
END;
                ...
                case 'Soci':
                     echo<<<END
                    <p>Scegli i valori per l'inserimento socio:</p>
                    <form class="fc" action = "ver_inserisci.php" method = "post">
                    <fieldset>
                    <div>
...
END;
                ...
                case 'SociRiunioni':
                    echo<<<END
                    <p>Scegli i valori per l'inserimento campo tabella sociriunioni:</p>
                    <form class="fc" action = "ver_inserisci.php" method = "post">
                    <fieldset>
                    <div>
                    <label>Socio:</label>
...
END;
                ...
                case 'Sub':
                     echo<<<END
                    <p>Scegli i valori per l'inserimento sub:</p>
                    <form class="fc" action = "ver_inserisci.php" method = "post">
                    <div>
                    <label>Id sub:</label>
