...
<html>
    ...
    <body>
        ...
        <div id="breadcrumb">
            Ti trovi in: <a href="index.php"> Home</a> >><a href="sezioneamm.php"> Sezione amministratore</a> >> Scelta cancellazione
        </div>
        ...
        <div id="content">
            ...
            if ($username != "Admin" && $username != "admin") {
                ...
                echo<<<END
        <form class="fc" method="post" action="cancella.php">
        <fieldset>
        <div>
        <label>Tipo di dato da eliminare:</label>
        <select name = "tipo_canc">
