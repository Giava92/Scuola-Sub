...
<html>
    ...
    <body>
        ...
        <div id="breadcrumb">
            ...
            <a href="sceglipersone.php"> Ricerca persone</a> >> Scelta Brevetto
        </div>
        ...
        <div id="content">
            ...
            if ($username != "Admin" && $username != "admin") {
                ...
                echo<<<END
        <p>Inserisci il nome del brevetto di cui vuoi sapere quanti sub lo possiedono:</p>
        <form class="fc" action = "risultatibrev.php" method = "post">
        <fieldset>
        <div>
        <label>Nome brevetto:</label> 
        ...
        <p>Torna alla <a href="sceglipersone.php">indietro</a>.</p>
