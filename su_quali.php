...
<html>
    ...
    <body>
        ...
        <div id="breadcrumb">
            ...
            <a href="sceglimodifica.php"> Scelta modifica</a> >><a href="modifica.php"> Valori modifica</a> >> Valori da modificare
        </div>
    ...
    } elseif (empty($_SESSION['tipo_mod'])) {
        echo "<p>Non hai scelto cosa modificare. <a href=\"sceglimodifica.php\">Riprova</a>.</p>";
    } else if (empty($_POST['tipo_dat'])) {
        echo "<p>Non hai scelto che tipo di dato modificare. <a href=\"sceglimodifica.php\">Riprova</a>.</p>";
    } elseif (empty($_POST['new_v'])) {
        echo "<p>Non hai scelto il nuovo valore per aggiornare i dati. <a href=\"sceglimodifica.php\">Riprova</a>.</p>";
    } else {
        $tipo_dat = $_POST['tipo_dat'];
        $new_v = $_POST['new_v'];
        require_once ("fun_su_quali.php");
        suquali($_SESSION['tipo_mod'], $tipo_dat);
        $_SESSION['tipo_dat'] = $tipo_dat;
        $_SESSION['new_v'] = $new_v;
        
        echo "</p><p>Torna <a href=\"sceglimodifica.php\">indietro</a>.</p>"
