...
<html>
    ...
    <body>
        ...
        <div id="breadcrumb">
            ...
            <a href="sceglipersone.php"> Ricerca persone</a> >> Spesa totale
        </div>
        ...
        <div id="content">
            ...
            if ($username != "Admin" && $username != "admin") {
                ...
                echo<<<END
        <p>Inserisci l'id della persona di cui vuoi sapere la spesa.</p>
        <form class="fc" action = "risultatispesa.php" method = "post">
        <fieldset>
        <div>
