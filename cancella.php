...
<html>
    ...
    <body>
        ...
        <div id="breadcrumb">
            ...
            <a href="sceglicancella.php"> Scelta cancellazione</a> >> Valori per cancellazione
        </div>
        ...
        <div id="content">
            ...
            } else if (empty($_POST['tipo_canc'])) {
                echo "<p>Non hai scelto cosa eliminare. <a href=\"sceglicancella.php\">Riprova</a>.</p>";
            } else {
                $tipo_canc = $_POST['tipo_canc'];
                require_once ("fun_cancella.php");
                cancella($tipo_canc);
                $_SESSION['tipo_canc'] = $tipo_canc;
                echo "<p>Torna <a href=\"sceglicancella.php\">indietro</a>.</p>"
