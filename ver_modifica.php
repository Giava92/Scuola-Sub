...
<html>
    ...
    <body>
        ...
        <div id="breadcrumb">
            ...
            <a href="sceglimodifica.php"> Scelta modifica</a> >><a href="modifica.php"> Valori modifica</a> >>
            <a href="su_quali.php"> Valori da modificare</a> >> Verifica modifica
        </div>
        ...
        <div id="content">
            ...
            if ($username != "Admin" && $username != "admin") {
                ...
                require_once ("fun_ver_modifica.php");
                ver_mod($_SESSION['tipo_mod'], $_SESSION['tipo_dat'], $_SESSION['new_v']);
            }
            ?>
        </div>
