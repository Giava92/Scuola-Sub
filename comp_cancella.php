...
<html>
    ...
    <body>
        ...
        <div id="breadcrumb">
            ...
            >><a href="ver_cancella.php"> Verifica cancellazione</a> >> Completamento cancellazione
        </div>
        ...
        <div id="content">
            ...
            if ($username != "Admin" && $username != "admin") {
                ...
                $tipo_canc = $_SESSION['tipo_canc'];

                require_once ("con_db.php");
                require_once ("fun_comp_cancella.php");
                comp_canc($tipo_canc);
